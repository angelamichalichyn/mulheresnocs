...
module.exports = async (req, res) => {
  ...
  try {
    ...
    await pool.query(
      `INSERT INTO cadastros (nome_completo, nick, data_nascimento, endereco, cpf_hash, cpf_situacao, cpf_nome_receita, foto_url, foto_public_id)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)`,
      [nome_completo.trim(), nick.trim(), data_nascimento, endereco?.trim() || null,
